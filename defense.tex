  ...
  \section{Introduction}
    ...
    \begin{frame}
      ...
      \begin{center}
        ...
        \multirow{5}*{\uncover<6->{Bosons}} & \uncover<6->{$\gamma$} & \uncover<7->{$\rightarrow$} & \uncover<7->{E.M. interaction} \tabularnewline
...
\begin{frame}
    ...
    \vspace{-0.3cm}
    \begin{center}
        $m_H~\simeq~125~\text{GeV and }\sqrt{s} = 350~\text{GeV} \Rightarrow$ Higgs Strahlung and WW-fusion have comparable cross sections.  
    \end{center}
    \vspace{-0.1cm}
    \begin{columns}[c]
        \begin{column}{5cm}
