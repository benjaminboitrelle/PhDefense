...
\begin{document}
    ...
    \uncover<2->{
      \begin{columns}[c]
        ...
        \begin{column}{5cm}
          ...
          \
          Electroweak symmetry breaking and physics beyond the Standard Model: from $100~\text{GeV}$ to TeV scale
        \end{column}
      \end{columns}  
    }
  ...
  \begin{frame}
    ...
    \begin{columns}[c]
      \begin{column}{4cm}
        \centering
          ...
          \includegraphics[width =\textwidth]{Pictures/lhc_sousterrain_schema.jpg}
      \end{column}
    ...
    \uncover<2>{
      \vspace{0.3cm}
      \centering{\textbf{$\Rightarrow$ Need a complementary experimental program}}
    }
...
\begin{frame}
  ...
  \begin{block}{Events selection}
    \begin{enumerate}
      ...
      \item Look for jets
      \item Find displaced vertices of these jets
      \item Tag 2 jets coming from the Higgs boson decay
    \end{enumerate}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Goals}
    \begin{itemize}
      ...
      \item \only<1>{Study the mechanical structure and its impact on sensors' performance} \only<2>{\textbf{Study the mechanical structure and its impact on sensors' performance}}
    \end{itemize}
  \end{block}
...
%-------------------------------
  ...
  \begin{frame}
    ...
    \begin{block}{Spatial residuals}
      ...
      \end{center}
      \vspace{-0.35cm}
      \centering{$\sigma_{tel} = 2.2~\mu\text{m}$ for 36\degres and $\sigma_{tel} = 18.8~\mu\text{m}$ for 60\degres.}
    \end{block}
...
\begin{frame}[plain]
    ...
    \vspace{-0.2cm}
    \centering{Study of two planes in normal incidence (w.r.t the beam axis)}
...
\begin{frame}[plain]
    \frametitle{Estimation of the angular resolution}

    \only<1>{
    \begin{center}
        \includegraphics[width = 8 cm]{Pictures/mini_vectors.pdf}
    \end{center}     
        
    }
    \vspace{-0.3cm}
    \only<1->{\begin{block}{Estimation of the angular resolution}
        \begin{columns}[t]
            \begin{column}{6cm}
             \[
              \begin{array}{rl}
                  %\sigma_{\theta} &= \frac{\sigma_{s1} + \sigma_{s2}}{d} \\
                  \sigma_{\theta} &= \frac{\sqrt{\sigma_{s1}^2 + \sigma_{s2}^2}}{d} \\
                  \sigma_{\theta} &\simeq 0.146\degres \\
              \end{array}
             \]
             \end{column}
            \begin{column}{6cm}
                  \[ with \ \sigma_{s1} \ = \ \sigma_{s2} \ \simeq 3.6 \ \mu m\]
            \end{column}
       \end{columns}
    \end{block}}
    \only<2>{
    \begin{center}
        \begin{columns}[t]
            \begin{column}{7cm}
                \includegraphics[width = 7cm]{Pictures/hDiffAngleX_226056.png}
            \end{column}
            \begin{column}{4cm}
                \vspace{-5cm}
               \begin{alertblock}{Angular resolution}
                    Can not be simply quoted by a Gaussian standard deviation
               \end{alertblock}
            \end{column}
        \end{columns}
    \end{center}
...
\begin{frame}[plain]
    ...
    \vspace{-0.3cm}
    \begin{itemize}
        \item Cluster position determined by its centre of gravity %: if only 1 pixel hit is considered in the center of the pixel 
    ...
    \begin{columns}[b]
       \begin{column}{4cm}
        \begin{center}
            ...
            \only<1>{\includegraphics[width = 4cm]{Pictures/cluster1x1_jerome.png}}
            \only<2>{\includegraphics[width = 4 cm]{Pictures/hDiffAngleX11_226056.png}}
            
%            Distance between 2 pixels: 18.4 $\mu$m
%
%            $\Rightarrow$ 0.53 \degres deviation
        \end{center}
       \end{column}
       ...
       \begin{column}{4cm}
         \begin{center}
            ...
            \only<1>{\includegraphics[width = 4cm]{Pictures/cluster1x2_jerome.png}}
            \only<2>{\includegraphics[width = 4 cm]{Pictures/hDiffAngleX21_226056.png}}
        \end{center}
       \end{column}

       \begin{column}{4cm}
        \begin{center}
            \scriptsize{Cluster > 2px on each side}
            
            \only<1>{\includegraphics[width = 4cm]{Pictures/cluster2x2_jerome.png}}
            \only<2>{\includegraphics[width = 4 cm]{Pictures/hDiffAngleXg1g1_226056.png}}
        \end{center}
...
%-------------------------------
%   BACK-UP: ILC-ILD other detectors
