   ...
   \begin{frame}
     ...
     %\begin{block}{Standard Model:}
        \begin{itemize}
          ...
          \item Last milestone: discovery of the Higgs Boson that confirms the EWSB
        \end{itemize}
    ...
    \begin{frame}
      ...
      \begin{alertblock}{Limitations:}
        \begin{itemize}
          ...
          %\item Why such a difference mass scale between generations?
...
\section{Higgs boson study}
  ...
  \subsection{Motivation}
    ...
    \begin{frame}
      ...
      %  \begin{itemize}
      %    \item Higgs-Brout-Englert mechanism: how particles acquire mass via Higgs field
